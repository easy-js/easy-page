...
var Page = function (page, opts) {
  ...
  this.opts.pkg  = path.resolve(this.opts.root, this.opts.pkg);

  // page should have a reference to its name while templating.
  this.opts.data.pageName = page.pageName;

  // avoid ugly scoping issues.
  _.bindAll(this, 'create', '_addData','_addSections', '_buildSection',
    '_getSection', '_templateSection', '_compileSection',
...
Page.prototype._render = function (callback) {
  var tmpl = path.resolve(this.opts.root, this.page.tmpl || this.opts.tmpl);
